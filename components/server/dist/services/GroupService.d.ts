...
export declare const getGroup: (data: { context: Context; groupId: number }) => Promise<
  Group & {
...
>;
export declare const getGroupForUser: (data: { context: Context; groupId: number }) => Promise<
  Group & {
    members: (GroupMember & {
      user: import(".prisma/client").User;
      organizationMember: import(".prisma/client").OrganizationMember;
...
>;
export declare const deleteGroup: (data: { context: Context; groupId: number }) => Promise<Group>;
