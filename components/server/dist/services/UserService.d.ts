...
export declare const deleteUser: (data: { context: Context }) => Promise<User>;
...
export declare const resetPassword: (data: { context: Context; email: string }) => Promise<User>;
export declare const getJoinedEntities: (data: { context: Context }) => Promise<
  | (User & {
      organizations: (import(".prisma/client").OrganizationMember & {
